...
function sendReservationEmail(user, reservation,reservationId, token) {
  ...
  const checkoutUrl = `http://localhost:5173/reservations/${user.id}/${reservationId}?token=${token}`;
