...
import logo2 from "../../assets/homepage_mats/name.png";
...
import AcceptContent from "./DashComponents/AcceptContent/AcceptContent";
    ...
    <div className={`_dash_container ${isNavClosed ? "nav-closed" : ""}`}>
      <div className="header">
        <div className="header-logo" onClick={() => navigate("/")}>
          ...
          <img
            ...
            alt="City Flat"
            id="header-logo-2"
            className={isNavOpen ? "header-logo-2-max" : "header-logo-2-min"}
          />
        </div>
      ...
      <div className="main">
        <div className="sidebar">
          <nav className={isNavOpen ? "nav-max" : "nav-min"} id="sidebar_nav">
            {/*      
          <br />
      <hr /> */}
                ...
                >
                  <div>
                    ...
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clip-path="url(#clip0_1231_273)">
                        <path
                          d="M3.05591 7.40234L2.49528 6.84172L3.28516 6.05134C3.12642 5.97389 2.95218 5.93312 2.77559 5.93237C2.11868 5.93237 1.58594 6.46512 1.58594 7.12203C1.58594 7.77894 2.11868 8.31168 2.77559 8.31168C3.43251 8.31168 3.96525 7.77894 3.96525 7.12203C3.9645 6.94544 3.92373 6.7712 3.84628 6.61246L3.05591 7.40234Z"
                          fill="currentColor"
                        />
                        <path
                          d="M3.05591 16.9196L2.49528 16.359L3.28516 15.5686C3.12642 15.4912 2.95218 15.4504 2.77559 15.4496C2.11868 15.4496 1.58594 15.9824 1.58594 16.6393C1.58594 17.2962 2.11868 17.829 2.77559 17.829C3.43251 17.829 3.96525 17.2962 3.96525 16.6393C3.9645 16.4627 3.92373 16.2885 3.84628 16.1297L3.05591 16.9196Z"
                          fill="currentColor"
                        />
                        <path
                          d="M3.05591 12.161L2.49528 11.6004L3.28516 10.81C3.12642 10.7326 2.95218 10.6918 2.77559 10.691C2.11868 10.691 1.58594 11.2238 1.58594 11.8807C1.58594 12.5376 2.11868 13.0704 2.77559 13.0704C3.43251 13.0704 3.96525 12.5376 3.96525 11.8807C3.9645 11.7041 3.92373 11.5299 3.84628 11.3711L3.05591 12.161Z"
                          fill="currentColor"
                        />
                        <path
                          d="M17.8448 11.4841C18.5208 11.4856 19.1912 11.6031 19.8276 11.8311V1.57033C19.8276 0.913419 19.2948 0.380676 18.6379 0.380676H1.18966C0.532743 0.380676 0 0.913419 0 1.57033V19.0186C0 19.6755 0.532743 20.2083 1.18966 20.2083H12.5878C11.6117 18.3655 11.6732 16.1458 12.7493 14.3597C13.8258 12.5734 15.7595 11.4823 17.8448 11.4841ZM12.6897 13.0703H9.51724V12.2772H12.6897V13.0703ZM12.6897 11.4841H5.94828V10.691H12.6897V11.4841ZM8.72414 12.2772V13.0703H5.94828V12.2772H8.72414ZM8.72414 7.51861V8.31171H5.94828V7.51861H8.72414ZM5.94828 6.7255V5.9324H12.6897V6.7255H5.94828ZM15.069 11.4841H13.4828V10.691H15.069V11.4841ZM15.069 8.31171H9.51724V7.51861H15.069V8.31171ZM17.4483 6.7255H13.4828V5.9324H17.4483V6.7255ZM3.96552 1.17378H4.75862V1.96688H3.96552V1.17378ZM2.37931 1.17378H3.17241V1.96688H2.37931V1.17378ZM0.793104 1.17378H1.58621V1.96688H0.793104V1.17378ZM0.793104 2.75999H19.0345V3.55309H0.793104V2.75999ZM4.75862 16.6393C4.76135 17.5514 4.14347 18.3482 3.25941 18.5726C2.37559 18.7973 1.45237 18.3918 1.01939 17.589C0.586773 16.7865 0.755183 15.7922 1.42833 15.177C2.10172 14.5619 3.10723 14.4833 3.86762 14.9868L4.87486 13.9797L5.43549 14.5403L4.42837 15.5475C4.64362 15.871 4.75862 16.2508 4.75862 16.6393ZM4.42837 10.7889C4.99184 11.6405 4.8191 12.7805 4.02822 13.4266C3.23747 14.0727 2.08574 14.0149 1.36377 13.2928C0.64167 12.5708 0.583799 11.4191 1.22993 10.6283C1.87606 9.83744 3.01602 9.6647 3.86762 10.2282L4.87486 9.22105L5.43549 9.78168L4.42837 10.7889ZM4.42837 6.0303C4.99184 6.88189 4.8191 8.02186 4.02822 8.66799C3.23747 9.31412 2.08574 9.25625 1.36377 8.53415C0.64167 7.81218 0.583799 6.66045 1.22993 5.8697C1.87606 5.07882 3.01602 4.90608 3.86762 5.46955L4.87486 4.46243L5.43549 5.02306L4.42837 6.0303ZM8.72414 17.829H5.94828V17.0359H8.72414V17.829ZM11.1034 17.829H9.51724V17.0359H11.1034V17.829ZM11.1034 16.2427H5.94828V15.4496H11.1034V16.2427Z"
                          fill="currentColor"
                        />
                        <path
                          d="M17.8446 12.2772C14.9975 12.2772 12.6895 14.5853 12.6895 17.4324C12.6895 20.2795 14.9975 22.5876 17.8446 22.5876C20.6917 22.5876 22.9998 20.2795 22.9998 17.4324C22.9966 14.5866 20.6904 12.2804 17.8446 12.2772ZM16.1422 19.6955C16.0678 19.7698 15.9671 19.8117 15.8619 19.8117C15.8406 19.8117 15.8195 19.81 15.7984 19.8065C15.6725 19.7862 15.5642 19.7065 15.507 19.5924L14.7138 18.0062L15.4237 17.6517L15.9704 18.7458L20.3402 14.3762L20.9008 14.9368L16.1422 19.6955Z"
                          fill="currentColor"
                        />
                      </g>
                      <defs>
                        <clipPath id="clip0_1231_273">
        ...
        <div
          className={`page-content scrollable-container ${
            isNavOpen ? "page-content-max" : "page-content-min"
          }`}
        ...
        >
          ...
          {activeIndex === 3 && <AcceptContent />}
          {activeIndex === 4 && <CustomersContent set />}
          {activeIndex === 5 && (
            <HelpContent showModal={showModal} closeModal={closeModal} />
          )}
          {activeIndex === 6 && <InvoiceContent />}
        </div>
      </div>
    </div>
  );
