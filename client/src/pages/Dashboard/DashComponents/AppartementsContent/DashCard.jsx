...
const handleEditImagesChange = (event) => {
  ...
  const maxLength = parseInt(event.target.getAttribute("data-max_length"), 10);
  ...
  setEditApartment((prevEditApartment) => ({
    ...prevEditApartment,
    images: selectedImages, // Replace existing pictures with newly selected images
  }));
};
        ...
        <div className="add_form">
          ...
          >
              ...
              <div>
                <div className="row">
                  <div className="col-4" style={{ paddingRight: 0 }}>
                    <label htmlFor="default_special_date.price">price:</label>
                    <input
                      type="number"
                      id="price"
                ...
                {/* {editApartment?.default_special_date.map((row, index) => (
                      ...
                      {editApartment?.images?.map((image, index) => (
                        <div key={index} className="upload__img-box">
                          <div
                            ...
                            className="img-bg"
                          >
                            <div className="upload__img-close"></div>
                          </div>
                        </div>
                      ))}
                    </div>
            ...
            <div className="wrap">
              <button
                type="submit"
                onClick={(event) => handleEditSubmit(event, editApartment.id)}
              >
                Submit
              </button>
            </div>
