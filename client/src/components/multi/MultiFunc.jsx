        ...
        <div className="searchwrapper">
          <div className="searchbox">
            <div className="row">
              ...
              <div className="col-sm-9 col-12 my-4 my-sm-0 d-flex  align-items-center">
                <RangeSlider
                  min={0}
                  max={1000}
                  onChange={({ min, max }) =>
              ...
              <div className="col-sm-2 col-12 mb-2 mt-3 my-sm-0 ">
                <button type="button" className="btn btn-primary d-flex align-items-center justify-content-sm-between justify-content-center">
                  <svg
                    width="25"
                    height="25"
                    viewBox="0 0 25 25"
          ...
          <div className="searchwrapper searchwrapper_modal">
            <div className="searchbox">
              <div className="row">
                ...
                {/* <div className="col-md-5" id="counter">
